...
const Railings = () => {
  ...
  const benefits = [
    {
      text: "Enhanced Safety — Railings provide secure support and prevent accidental falls, making spaces safer for children, seniors, and visitors.",
      icon: <FaShieldAlt className="text-[#F37021] text-xl sm:text-lg" />,
    },
    {
      text: "Modern Aesthetic — Sleek railing designs enhance the visual appeal of balconies, staircases, terraces, and decks.",
      icon: <FaStar className="text-[#F37021] text-xl sm:text-lg" />,
    },
    {
      text: "Durable & Long-Lasting — High-quality metal and glass railings resist rust, corrosion, and weather damage for years.",
      icon: <FaCubes className="text-[#F37021] text-xl sm:text-lg" />,
    },
    {
      text: "Low Maintenance — Tough materials and protective finishes require minimal cleaning and upkeep.",
      icon: <FaBroom className="text-[#F37021] text-xl sm:text-lg" />,
    },
    {
      text: "Versatile Design Options — Available in glass, stainless steel, aluminum, and hybrid designs to match modern and traditional architecture.",
      icon: <FaPalette className="text-[#F37021] text-xl sm:text-lg" />,
    },
    {
      text: "Adds Property Value — Stylish railings upgrade aesthetics and safety, improving overall investment value.",
      icon: <FaDollarSign className="text-[#F37021] text-xl sm:text-lg" />,
    },
  ];
