...
//   const benefits = [
//     "Seamless & Modern Appearance — Experience a smooth, uninterrupted glass surface that gives your project a premium and contemporary look.",
//     "Energy Efficient — Structural glazing helps maintain indoor temperature by reducing heat transfer, lowering air-conditioning and energy costs.",
//     "Enhanced Natural Light — Maximizes daylight inside the building, reducing dependency on artificial lighting and creating a bright environment.",
//     "Weather & Noise Protection  —  Airtight sealing prevents dust, water leakage, and noise intrusion—ideal for buildings located in busy or harsh environments.",
//     "Strong, Safe & Durable  —   High-strength silicone absorbs pressure caused by wind, temperature changes, and environmental vibrations, ensuring long life.",
//     "Flexible Design Options  —  Can be customized to fit various shapes and designs, making it suitable for commercial spaces, offices, showrooms, and modern homes.",
//   ];
